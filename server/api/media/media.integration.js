...
describe('Media API:', function () {
  ...
  describe('GET /api/media', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/media').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        medias = res.body;
  ...
  describe('POST /api/media', function () {
    beforeEach(function (done) {
      (0, _supertest2.default)(app).post('/api/media').send({
        name: 'New Media',
  ...
  describe('GET /api/media/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/media/' + newMedia._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        media = res.body;
  ...
  describe('PUT /api/media/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).put('/api/media/' + newMedia._id).send({
        name: 'Updated Media',
  ...
  describe('DELETE /api/media/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2.default)(app).delete('/api/media/' + newMedia._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when media does not exist', function (done) {
      (0, _supertest2.default)(app).delete('/api/media/' + newMedia._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=media.integration.js.map
