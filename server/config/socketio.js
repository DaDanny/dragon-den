...
function onConnect(socket) {
  ...
  require('../api/server/server.socket').register(socket);
  require('../api/memo/memo.socket').register(socket);
  require('../api/media/media.socket').register(socket);
  require('../api/roomTimeline/roomTimeline.socket').register(socket);
  require('../api/timelineTask/timelineTask.socket').register(socket);
  require('../api/baseObject/baseObject.socket').register(socket);
